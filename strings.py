...
UI_TEXT = {
    ...
    "error_solutions": "تأكد من اتصال الإنترنت وأعد المحاولة",
    "footer": "تحليل فني متقدم | توقعات مونت كارلو | إدارة مخاطر",
}
